...
import { DateTime } from 'luxon'; // Using Luxon for date manipulation

export default function NextMonthScreen() {
  const nextMonth = DateTime.now().plus({ months: 1 }).toFormat('yyyy-MM');
  ...
  return (
    <View style={styles.container}>
      ...
      <Calendar
        markingType="simple"
        current={`${nextMonth}-01`} // Sets the initial month to next month
        markedDates={{
